...
/**
 * UseCase central do fluxo HandleOrderTermination (F2-03).
 * <p>
 ...
 *   <li>Persistência da Position desbloqueada e da Transaction atualizada</li>
 *   <li>Cálculo do montante a ser estornado e publicação do {@code MarginReleaseEvent}</li>
 * </ol>
 * <p>
 ...
 */
@Slf4j
public class HandleOrderTerminationUseCase {
    ...
    public HandleOrderTerminationUseCase(
    ...
    /**
     * Executa o fluxo completo de encerramento da Transaction.
     * <p>
    ...
    public void handle(Transaction transaction) {
        ...
        findAndUnlockPosition(transaction).ifPresent(runnerRepository::savePosition);
