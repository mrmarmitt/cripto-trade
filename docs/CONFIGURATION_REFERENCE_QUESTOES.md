...
**Pergunta:** Quais são os valores default sensatos para os parâmetros configuráveis do Circuit Breaker Global (seção 10.5 do Blueprint)?
...
**Origem:** Blueprint seção 10.5 (valores marcados como configuráveis)
